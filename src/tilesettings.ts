...
export default {
  ...
  arcGisCanvas: {
    ...
    'EPSG:28992': {
      home:
        'https://services.arcgisonline.com/arcgis/rest/services/Basiskaarten/Canvas/MapServer/tile/',
      minLevel: 1,
      maxLevel: 12,
      origX: -285401.92,
      origY: 903401.92,
  ...
  arcGisTopo: {
    ...
    'EPSG:28992': {
      home:
        'https://services.arcgisonline.com/arcgis/rest/services/Basiskaarten/Topo/MapServer/tile/',
      minLevel: 1,
      maxLevel: 12,
      origX: -285401.92,
      origY: 903401.92,
  ...
  arcGisOceanBaseMap: {
    'EPSG:3857': {
      ...
      home:
        'https://services.arcgisonline.com/ArcGIS/rest/services/Ocean_Basemap/MapServer/tile/',
      minLevel: 1,
      maxLevel: 19,
      tileServerType: 'arcgisonline',
      copyRight:
  ...
  OpenStreetMap_Service: {
    ...
    'EPSG:28992': {
      home:
        'https://services.arcgisonline.com/ArcGIS/rest/services/Basiskaarten/PDOK_BRT/MapServer/tile/',
      minLevel: 1,
      maxLevel: 12,
      origX: -285401.92,
      origY: 903401.92,
